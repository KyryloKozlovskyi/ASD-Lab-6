...
public class AppWindow extends Application {
	...
	public void start(Stage stage) throws Exception { // This is a ***Template Method***
		...
		btnAdd.setOnAction(e -> { // Plant an observer on the button
			 ...
			 * following:
			 * 
			 * 1) This lambda implementation of EventHandler<ActionEvent> is an example of a
			 * **Controller** in the MVC. 2) We update the View (TableView) by changing the
			 * Model (ObservableList), i.e. we never directly update the view.
			 * 
			 */
			customers.add(new Customer("Sideshow Bob", LocalDateTime.of(1970, 7, 7, 0, 0), Status.Premium,
	...
	/*
	 * This method builds a table to display the customer details. This View could
	 * also have been encapsulated inside its own class using the signature
	 * 
